...
database_name = os.environ.get('database_name', 'fhzbyfez')
db_username = urllib.parse.quote_plus(str(os.environ.get('db_username', 'fhzbyfez')))
db_password = urllib.parse.quote_plus(str(os.environ.get('db_password', 'P8LZ58uk3fmXQ6v3mMPf4IH8cjjysLfC')))
